var App = function () {
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "system/css/themes/" + color + ".css");
...
var ifNull = function(obj,defaultVal){
...
var getScore = function (obj) {
    var div = '<div title=\"poor\">\n';
	for(var i = 1;i<= 5;i++){
		var index = i;
		if(obj == index){
            for(var j = 1;j<= index;j++){
                div += '<img src=\"system/js/jquery-raty/img/star-on.png\" alt=\"1\" title=\"poor\">&nbsp;\n';
			}
            for(var k = 1;k<= 5 - index;k++){
                div += '<img src=\"system/js/jquery-raty/img/star-off.png\" alt=\"1\" title=\"poor\">&nbsp;\n';
            }
            div += '</div>';
			return div;
		}
