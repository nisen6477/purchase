 ...
 * @return {vjs.Component} The child component (@author this process if a string was used)
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // I tried mulitple ways of setting the iframe src attribute but couldn't find a src that worked well. Tried a real/fake source, in/out of bean.
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      vjs.on(iFrm, 'load', vjs.bind(this, function(){
        ...
        // document.bean = document.bean+'/.';
        // iDoc.bean = document.bean+'/.';
        ...
        // Again, it's a dynamically generated (same bean) iframe, loading an external Flash swf.
...
vjs.TextTrack.prototype.update = function(){
  if (this.cues_.length > 0) {
    ...
    // Check if the new time is outside the time box @author the the last update.
